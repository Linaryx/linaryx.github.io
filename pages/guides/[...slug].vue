...
const prevLink = computed(() => {
    ...
    const nextIdx =
        (idx.value - 1 + allGuides.value.length) % allGuides.value.length;
...
const applyAnchorClasses = () => {
    ...
    if (!el) return;
    const headingAnchors = el.querySelectorAll<HTMLElement>(
...
<template>
        ...
        <header class="guide-hero">
            ...
            <div class="hero-content">
                ...
                <h1 class="hero-title">
                    ...
                    <span class="hero-author" v-if="guide.author"
                        >by {{ guide.author }}</span
                    >
                </h1>
    ...
    <main v-else class="guide-page">
        <section class="empty-state card">
            ...
            <NuxtLink to="/guides" class="btn primary"
                >Вернуться к списку</NuxtLink
            >
        </section>
    </main>
</template>
